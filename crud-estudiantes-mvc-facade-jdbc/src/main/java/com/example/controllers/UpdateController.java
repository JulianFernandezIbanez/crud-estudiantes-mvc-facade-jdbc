...
import com.example.services.FacultadesService;
import com.example.services.FacultadesServiceImpl;
...
public class UpdateController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		FacultadesService facultadesService = new FacultadesServiceImpl();
		...
		request.getRequestDispatcher("formularioAltaModificacion.jsp").forward(request, response);
	}
